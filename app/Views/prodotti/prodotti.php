            ...
            ?>
				<tr>
					...
					<td style="border: 1px solid;border-right:0;">
						<!-- MODIFICA -->
						<a href="UpdateProducts/<?=$prod['prodId']?>" class='btn btn-warning'><i class="material-icons">edit</i></a>
					</td>
					<td style="border: 1px solid;border-left:0;">
						<!-- ELIMINA -->
						<a href="DeleteProducts/<?=$prod['prodId']?>" class='btn btn-danger'><i class="material-icons">clear</i></a>
					</td>
				</tr>
		<?php endforeach; ?>
			</tbody>
