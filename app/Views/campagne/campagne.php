...
<div class="row">
	...
	<div class="col-md-2">
	<a href="/index.php/partitionUsers"><input type="button" class="btn btn-primary btn-lg" value="Lista utenti partition"></a>
	</div> -->
</div>
<br>
	<!-- STAMPO A VIDEO TUTTE LE CAMPAGNE --> 
	<div>
		<?= $template_campagne ?>
	</div>
</body>
