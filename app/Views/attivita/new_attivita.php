...
<div id="new_user">
	<div class="col-lg-2 col-12">
		<div class="row">
			<input type="hidden" name="id_update" value="<?=$attivita['id']?>">
			Nome: <input id="name" name="name" type="text" class="form-control" value="<?= !empty($attivita['nome']) ? $attivita['nome'] : set_value('name') ?>" autocomplete="off">
		</div>
		<div class="row">
